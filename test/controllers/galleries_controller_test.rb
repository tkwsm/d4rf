...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { description: @gallery.description, link: @gallery.link, sortnumber: @gallery.sortnumber, species_name: @gallery.species_name, version: @gallery.version } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { description: @gallery.description, link: @gallery.link, sortnumber: @gallery.sortnumber, species_name: @gallery.species_name, version: @gallery.version } }
